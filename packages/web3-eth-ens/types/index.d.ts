...
import { PromiEvent, TransactionConfig, TransactionReceipt } from 'https://deno.land/x/web3@v0.6.1/packages/web3-core@v0.6.1/types/index.d.ts';
import { TransactionRevertInstructionError } from 'https://deno.land/x/web3@v0.6.1/packages/web3-core-helpers@v0.6.1/types/index.d.ts';
import { Eth } from 'https://deno.land/x/web3@v0.6.1/packages/web3-eth@v0.6.1/types/index.d.ts';
import { Contract } from 'https://deno.land/x/web3@v0.6.1/packages/web3-eth-contract@v0.6.1/types/index.d.ts';
