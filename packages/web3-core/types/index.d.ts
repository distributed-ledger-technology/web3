...
import {
  ...
  JsonRpcPayload,
  JsonRpcResponse,
} from 'https://deno.land/x/web3v0.7.1/packages/web3-core-helpers/types/index.d.ts';
import { Method } from 'https://deno.land/x/web3v0.7.1/packages/web3-core-method/types/index.d.ts';
