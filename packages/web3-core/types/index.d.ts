...
import {
  ...
  JsonRpcPayload,
  JsonRpcResponse,
} from 'https://deno.land/x/web3@v0.6.1/packages/web3-core-helpers@v0.6.1/types/index.d.ts';
import { Method } from 'https://deno.land/x/web3@v0.6.1/packages/web3-core-method@v0.6.1/types/index.d.ts';
