...
import WebsocketProvider from 'https://deno.land/x/web3v0.7.1/packages/web3-providers-ws/src/index.js';
import HttpProvider from 'https://deno.land/x/web3v0.7.1/packages/web3-providers-http/src/index.js';
import IpcProvider from 'https://deno.land/x/web3v0.7.1/packages/web3-providers-ipc/src/index.js';
