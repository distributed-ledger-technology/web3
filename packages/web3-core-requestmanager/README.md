...
```js
const Web3WsProvider = require('https://deno.land/x/web3@v0.7.3/packages/web3-providers-ws/src/index.js');
const Web3RequestManager = require('https://deno.land/x/web3@v0.7.3/packages/web3-core-requestmanager/src/index.js');
