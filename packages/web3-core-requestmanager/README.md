...
```js
const Web3WsProvider = require('https://deno.land/x/web30.7.1/packages/web3-providers-ws/src/index.js');
const Web3RequestManager = require('https://deno.land/x/web30.7.1/packages/web3-core-requestmanager/src/index.js');
