...
import numberToBN from 'https://jspm.dev/number-to-bn';
...
var sha3 = function (value) {
  ...
  const returnValue = ethereumjsUtil.bufferToHex(ethereumjsUtil.keccak256(value));
