...
import ENS from 'https://deno.land/x/web3@v0.9.1/packages/web3-eth-ens/src/index.js';
import Personal from 'https://deno.land/x/web3@v0.9.1/packages/web3-eth-personal/src/index.js';
import BaseContract from 'https://deno.land/x/web3@v0.9.1/packages/web3-eth-contract/src/index.js';
import Iban from 'https://deno.land/x/web3@v0.9.1/packages/web3-eth-iban/src/index.js';
import Accounts from 'https://deno.land/x/web3@v0.9.1/packages/web3-eth-accounts/src/index.js';
