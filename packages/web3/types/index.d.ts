...
import { Bzz } from 'https://deno.land/x/web3@v0.9.0/packages/web3-bzz/types/index.d.ts';
import {
...
import { Shh } from 'https://deno.land/x/web3@v0.9.0/packages/web3-shh/types/index.d.ts';
import { Utils } from 'https://deno.land/x/web3@v0.9.0/packages/web3-utils/types/index.d.ts';
