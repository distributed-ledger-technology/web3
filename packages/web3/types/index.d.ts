...
import { Bzz } from 'https://deno.land/x/web3@v0.9.1/packages/web3-bzz/types/index.d.ts';
import {
  BatchRequest, provider, Providers, Extension, 
} from 'https://deno.land/x/web3@v0.9.1/packages/web3-core/types/index.d.ts';
import { Eth } from 'https://deno.land/x/web3@v0.9.1/packages/web3-eth/types/index.d.ts';
...
import { Shh } from 'https://deno.land/x/web3@v0.9.1/packages/web3-shh/types/index.d.ts';
import { Utils } from 'https://deno.land/x/web3@v0.9.1/packages/web3-utils/types/index.d.ts';
