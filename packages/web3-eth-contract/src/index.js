 ...
 *
 *  var Contract = require('https://deno.land/x/web3@v0.8.5/packages/web3-eth-contract/src/index.js');
...
import { subscription as Subscription } from 'https://deno.land/x/web3@v0.8.5/packages/web3-core-subscriptions/src/index.js';
