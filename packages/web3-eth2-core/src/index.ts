import Axios, { AxiosInstance } from 'https://jspm.dev/axios';

import { ETH2BaseOpts, ETH2Function, BaseAPISchema } from '../types.ts';

Axios.defaults.adapter = require('https://jspm.dev/axios/lib/adapters/http');
